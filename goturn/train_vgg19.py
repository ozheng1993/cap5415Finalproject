...
import os
import goturn_net_VGG19 as goturn_net
#import  goturn_net
NUM_EPOCHS = 500
BATCH_SIZE = 50
WIDTH = 227
        ...
        for i in range(start, int(len(train_box) / BATCH_SIZE * NUM_EPOCHS)):
            if i % int(len(train_box) / BATCH_SIZE) == 0:
                ...
                if i > start:
                    ...
                    last_save_itr = i
                    model_saver.save(sess, "checkpoints_vgg19/" + save_ckpt, global_step=i + 1)
