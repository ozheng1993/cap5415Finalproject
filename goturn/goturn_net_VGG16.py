...
class TRACKNET: 
    ...
    def build(self):
        ...
        # now 28 x 28 x 256
        self.target_pool3 = tf.nn.max_pool(self.target_conv7, ksize = [1, 2, 2, 1], strides=[1, 2, 2, 1],
        ...
        # now 28 x 28 x 512
        self.target_conv8 = self._conv_relu_layer(bottom = self.target_lrn3, filter_size = [3, 3, 256, 512],
                                                    strides = [1,1,1,1], pad = 1, name = "target_conv_8")

        # now 28 x 28 x 512
        self.target_conv9 = self._conv_relu_layer(bottom = self.target_conv8, filter_size = [3, 3, 512, 512],
        ...
        # now 14 x 14 x 512
        self.target_pool4 = tf.nn.max_pool(self.target_conv10, ksize = [1, 2, 2, 1], strides=[1, 2, 2, 1],
                                                    padding='VALID', name='target_pool4')


        # now 28 x 28 x 256 
        self.target_lrn4 = tf.nn.local_response_normalization(self.target_pool4, depth_radius = 2, alpha=0.0001,
                                                    beta=0.75, name="target_lrn4")


        # now 14 x 14 x 512
        self.target_conv11 = self._conv_relu_layer(bottom = self.target_lrn4, filter_size = [3, 3, 512, 512],
        ...
        # now 14 x 14 x 512
        self.target_conv13 = self._conv_relu_layer(bottom = self.target_conv12, filter_size = [3, 3, 512, 512],
                                                    strides = [1,1,1,1], pad = 1, name = "target_conv_13")

        # now 7 x 7 x 512
        self.target_pool5 = tf.nn.max_pool(self.target_conv13, ksize = [1, 2, 2, 1], strides=[1, 2, 2, 1],
        ...
        # now 112 x 112 x 128
        self.image_conv3 = self._conv_relu_layer(bottom = self.image_lrn1, filter_size = [3, 3, 64, 128],
        ...
        # now 56 x 56 x 256
        self.image_conv5 = self._conv_relu_layer(bottom = self.image_lrn2, filter_size = [3, 3, 128, 256],
        ...
        # now 28 x 28 x 256
        self.image_pool3 = tf.nn.max_pool(self.image_conv7, ksize = [1, 2, 2, 1], strides=[1, 2, 2, 1],
                                                    padding='VALID', name='image_pool3')
        
        # now 28 x 28 x 512
        self.image_lrn3 = tf.nn.local_response_normalization(self.image_pool3, depth_radius = 2, alpha=0.0001,
                                                    beta=0.75, name="image_lrn3")
    
        # now 28 x 28 x 512
        self.image_conv8 = self._conv_relu_layer(bottom = self.image_lrn3, filter_size = [3, 3, 256, 512],
                                                    strides = [1,1,1,1], pad = 1, name = "image_conv_8")

        # now 28 x 28 x 512
        self.image_conv9 = self._conv_relu_layer(bottom = self.image_conv8, filter_size = [3, 3, 512, 512],
        ...
        # now 14 x 14 x 512
        self.image_pool4 = tf.nn.max_pool(self.image_conv10, ksize = [1, 2, 2, 1], strides=[1, 2, 2, 1],
                                                    padding='VALID', name='image_pool4')
        
        # now 14 x 14 x 512
        self.image_lrn4 = tf.nn.local_response_normalization(self.image_pool4, depth_radius = 2, alpha=0.0001,
                                                    beta=0.75, name="image_lrn4")        

        # now 14 x 14 x 512
        self.image_conv11 = self._conv_relu_layer(bottom = self.image_lrn4, filter_size = [3, 3, 512, 512],
        ...
        # now 14 x 14 x 512
        self.image_conv13 = self._conv_relu_layer(bottom = self.image_conv12, filter_size = [3, 3, 512, 512],
                                                    strides = [1,1,1,1], pad = 1, name = "image_conv_13")

        # now 7 x 7 x 512
        self.image_pool5 = tf.nn.max_pool(self.image_conv13, ksize = [1, 2, 2, 1], strides=[1, 2, 2, 1],
