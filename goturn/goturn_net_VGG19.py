...
class TRACKNET: 
    ...
    def build(self):
        ...
        # now 28 x 28 x 512
        self.image_conv9 = self._conv_relu_layer(bottom = self.image_lrn3, filter_size = [3, 3, 256, 512],
        ...
        # now 14 x 14 x 512
        self.image_conv13 = self._conv_relu_layer(bottom = self.image_lrn4, filter_size = [3, 3, 512, 512],
